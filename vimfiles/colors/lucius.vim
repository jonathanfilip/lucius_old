...
elseif g:lucius_style == "light"
    ...
    hi Constant     guifg=#b05000   guibg=NONE      ctermfg=130    ctermbg=NONE      gui=none      cterm=none
    hi BConstant    guifg=#b05000   guibg=NONE      ctermfg=130    ctermbg=NONE      gui=bold      cterm=bold
    ...
    hi Identifier   guifg=#208000   guibg=NONE      ctermfg=22     ctermbg=NONE      gui=none      cterm=none
    hi BIdentifier  guifg=#208000   guibg=NONE      ctermfg=22     ctermbg=NONE      gui=bold      cterm=bold

...
if g:lucius_style == "dark"
    ...
    hi Constant     guifg=#b8c080   guibg=NONE      ctermfg=187    ctermbg=NONE      gui=none      cterm=none
    hi BConstant    guifg=#b8c080   guibg=NONE      ctermfg=187    ctermbg=NONE      gui=bold      cterm=bold
